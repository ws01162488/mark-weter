package com.xuanwu.ump.mark_water.service;
...
import com.xuanwu.ump.mark_water.Const;

@Service
public class ImageWatermarkService {
	/**
	 * imgFile 图像文件 imageFileName 图像文件名 uploadPath 服务器上上传文件的相对路径 realUploadPath
	 * 服务器上上传文件的物理路径
	 */
